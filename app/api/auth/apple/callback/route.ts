...
// Do not construct the client at module load time because the service-role
// key may not be present during build / static analysis and the
// supabase-js constructor will throw if the key is missing.
